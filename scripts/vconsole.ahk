...
buttons["Half-Life: Alyx Maps"].push(new CommandButton("When You First Enter the Vault", "map a5_vault"))
buttons["Half-Life: Alyx Maps"].push(new CommandButton("Right Before", "map a5_ending"))
