...
titles.push({title:"Arma 2: British Armed Forces Uninstall ahk_class #32770",text:"Arma 2: British Armed Forces was successfully uninstalled.",action:"CloseWindow"})
...
titles.push({title:"Saving ahk_class #32770 ahk_exe TS SE Tool.exe",text:"File saved",action:"ClickButton$OK"})
titles.push({title:"Already running! ahk_class SunAwtDialog ahk_exe javaw.exe",text:"",action:"CloseWindow"})
titles.push({title:"ADB AppControl ahk_class #32770 ahk_exe ADBAppControl.exe",text:"The device does not respond for a long time and may be in sleep mode.",action:"CloseWindow"})
titles.push({title:"Internal Failure ahk_class #32770 ahk_exe ChilloutVR.exe",text:"Failed to load original DLL",action:"CloseWindow;Run$steam://rungameid/661130"})
titles.push({title:"Test ahk_class #32770 ahk_exe AutoHotkeyU64.exe",text:"",action:"CloseWindow;Run$steam://rungameid/661130"})
titles.push({title:"ahk_exe WWAHost.exe",text:"",action:"CloseWindow;KillProcess"})
...
; ads.raidrive.com/standard/c/widget_202309?v=2023.9.209&s=300x250&l=en
