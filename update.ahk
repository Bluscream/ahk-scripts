...
RunWaitOne("Powershell-ISE '" . A_ScriptDir . "\release.ps1' -token " . GitHubToken . " -tag '" . tag . "' -name '" . tag . "' -descr 'Release created with AutoHotKey and Powershell' -user 'Bluscream' -project 'ahk-scripts' -file '" . Binaries . "'")
