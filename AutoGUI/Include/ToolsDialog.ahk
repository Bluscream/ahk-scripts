ShowToolsDialog:
    ...
    ;Gui Font, s11 cWhite Bold q4, Segoe UI
    Gui Font, s12 cWhite, Segoe UI
    Gui Add, Text, x12 y12 w120 h23 +0x200 +BackgroundTrans, Tools
    Gui Font
    Gui Add, Text, x0 y46 w724 h2 0x10 ; Separator

    Gui Font, s9, Segoe UI
    Gui Add, ListView, hWndhLVTools gLVToolsHandler x8 y56 w224 h308 -Hdr -Multi +LV0x14000 +AltSubmit, Tools
    Gui Add, Button, gAddTool x6 y370 w84 h24 +Default, &Add
    Gui Add, Button, gRemoveTool x93 y370 w84 h24, &Remove
    Gui Add, Button, hWndhBtnToolUp gMoveToolUp x181 y370 w24 h24
    GuiButtonIcon(hBtnToolUp, IconLib, 127, "L2 T1")
    Gui Add, Button, hWndhBtnToolDown gMoveToolDown x209 y370 w24 h24
    GuiButtonIcon(hBtnToolDown, IconLib, 128, "L2 T1")

    Gui Add, Text, x251 y58 w88 h23 +0x200, Title:
    ...
    Gui Add, Button, gToolsDlgOK x443 y412 w84 h24, &OK
    Gui Add, Button, gToolsDlgClose x536 y412 w84 h24, Cancel
    Gui Add, Button, gToolsDlgApply x628 y412 w84 h24, Apply
